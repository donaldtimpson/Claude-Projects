...
struct LyceumPressStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        return configuration.label
            ...
            // Light instantly on touch-down so the glow registers before a quick tap triggers
            // navigation; ease the fade-out on release.
            .animation(down ? nil : .easeOut(duration: 0.22), value: down)
    }
}
