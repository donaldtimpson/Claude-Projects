...
// Problem Sets tab: all problem sets for this course, in creation order
// (matches the public course-page ordering). Create form is pre-scoped.
export default async function AdminCourseProblemSets({
  params,
}: {
